...
class TestESADataset(unittest.TestCase):
    ...
    def test_expected_window_counts(self):
        self.assertEqual(len(self.make_dataset("train")), 12524)
        self.assertEqual(len(self.make_dataset("validation", 0.5)), 2744)
        self.assertEqual(len(self.make_dataset("test", 0.1)), 2663)
